            ...
            <div className={cx("wraper")}>
                ...
                <div className={cx("wrap-listOptions")}>
                    <div className={cx("listOption-Messages")}>
                        <svg className="css-y48l9g-StyledIcon e1nx07zo1" width="1em" data-e2e="" height="1em" viewBox="0 0 48 48" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className={cx("listOption-Inbox")}>
                        <svg className="css-1g0p6jv-StyledInboxIcon e18kkhh41" width="32" data-e2e="" height="32" viewBox="0 0 32 32" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
