...
function KeyboardShotcuts(checkClickKeyboardShotcut) {
    ...
    const classWraper = classNames(
        'relative flex flex-col items-center pt-[40px] px-[32px] pb-[32px] bg-[#ffffff] rounded-[10px] w-[400px] h-[280px] animate-fadeIn',
    ...
    return (
        <WrapMenuHasBackGround>
            <div className={classWraper}>
                <div className="w-full h-[22px] text-[#161823] text-[24px] font-bold text-center leading-[22px] mb-[16.8px]">
                    Keyboard shortcuts
                </div>
                ...
                <div
                    onClick={() => value.setIconClose(true)}
                    className="absolute top-[18px] right-[18px] w-[24px] h-[24px] rounded-full bg-backGround flex items-center justify-center"
                >
                    <KeyBoardShotCutIconClose />
                </div>
            </div>
