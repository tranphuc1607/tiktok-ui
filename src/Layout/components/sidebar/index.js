...
function Sidebar() {
    ...
    return (
        ...
        >
            {base.map((item) => (
                <ListOptionsItem
                    setCheckOnClickIem={setCheckOnClickIem}
                    key={item.id}
                    id={item.id}
                    onclick={item.id === checkOnClickItem}
                    Icon={item.icon}
                    tital={item.tital}
                />
            ))}
            ...
            <div className="w-[224px] pl-[8px] flex flex-col items-start justify-center z-0">
                ...
                <div className="relative w-[208px] h-[52px]">
                    <img
                        ...
                        alt="lỗi"
                    />
                    <h4 className="absolute top-[10px] right-[17px] text-[#fff5c9] z-10 w-[141px] h-[32px] text-[13px] leading-[16px] font-bold">
                        Creater Tiktok effects, get a reward
                    </h4>
                </div>
                <div className="w-[216px] mt-[28px] flex flex-col items-start cursor-default">
                    <div className="w-[216px] h-[45px] flex flex-col">
                        <h4 className="w-full h-[22px] text-start text-colorLetterBold1 font-bold text-[15px] leading-[22px]">
                            Company
                        </h4>
                        <div className="flex w-full h-[23px] font-semibold text-[12px] text-colorLetterBold1 items-end gap-[6px] ">
                            <a href="/tiktok" className="cursor-default hover:underline">
                                About
                            </a>
                            <a href="/tiktok" className="cursor-default hover:underline">
                                NewSroom
                    ...
                    {!checkOnclickShow && (
                        <div
                            onClick={() => setCheckOnclickShow(true)}
                            className="flex items-center jutify-start w-[216px] h-[18px] mb-[20px] text-color"
                        >
