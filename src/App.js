                  ...
                  <Valiable.Provider  
                    ...
                    <div className="block top-0 left-0 w-full h-full">
                      {(clickMenu2Item && !clickMenu3Item) && 
                        <Modal setClickIconCloseInMenu3 = {setClickIconCloseInMenu3} clickMenu2 = {clickMenu2Item}  clickMenu3Item = {clickMenu3Item}/>
                      } 
                      {(clickMenu3Item) && 
                        <Menu4  clickMenu3Item = {clickMenu3Item} setClickButtonDone = {setClickButtonDone} clickButtonDone = {clickButtonDone}/>
                      }
                      {(checkClickKeyboardShotcut) && 
                        <KeyboardShotcuts checkClickKeyboardShotcut = {checkClickKeyboardShotcut}/>
                      }
                    </div>
                  </Valiable.Provider>
                  }/>
